...
from models import Official_Request


class Requests2(object):
...
"color:#c5c6c7")
        ...
        self.tb5 = QtWidgets.QTextEdit(self.formLayoutWidget)
        ...
        self.formLayout.setWidget(5, field, self.dateEdit)
...
# Adding Placeholders and setting names
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.l5.setText(_trans("MainWindow", "Request Title"))
        self.l6.setText(_trans("MainWindow", "Request Body"))
        self.l7.setText(_trans("MainWindow", "Date"))
        ...
        self.tb4.setPlaceholderText(
            _trans("MainWindow", "Please Enter Request Title Here"))
        self.tb5.setPlaceholderText(
            _trans("MainWindow", "Please Enter Full Request Here"))
    ...
    def pressed(self):
        ...
        t5 = self.tb5.toPlainText()
        t6 = self.dateEdit.date().toPyDate()
        ...
        # cur.execute("INSERT INTO Official_Requests (Student_id, Student_name, Student_email, Req_title, Req_body, Req_date) Values(%s,%s,%s,%s,%s,%s)", (t2,t1,t3,t4,t5,t6))

        # conn.commit()
        # cur.close()
        # conn.close()

        off_req = Official_Request(t2, t1, t3, t4, t5, t6)
        off_req.insert()
